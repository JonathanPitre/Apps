...
If ([version]$appVersion -gt [version]$appInstalledVersion) {
    ...
    If (-Not(Test-Path -Path $appScriptPath\$appVersion\$appSetupUninstaller)) {
    ...
    Copy-File -Path "$appScriptPath\mms.cfg" -Destination "$appDestinationx86"
    Copy-File -Path "$appScriptPath\mms.cfg" -Destination "$appDestinationx64"
