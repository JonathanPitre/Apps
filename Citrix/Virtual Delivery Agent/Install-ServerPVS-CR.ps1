...
$appInstallParameters = '/components vda /disableexperiencemetrics /enable_hdx_ports /enable_hdx_udp_ports /enable_real_time_transport /enable_remote_assistance /enable_ss_ports /exclude "Citrix Personalization for App-V - VDA","Citrix Supportability Tools","Citrix VDA Upgrade Agent","Citrix MCS IODriver" /includeadditional "Machine Identity Service","Citrix Profile Management","Citrix Profile Management WMI Plug-in","Citrix Rendezvous V2","Citrix Web Socket VDA Registration Tool" /masterpvsimage /noreboot /noresume /quiet /remove_appdisk_ack /remove_pvd_ack'
