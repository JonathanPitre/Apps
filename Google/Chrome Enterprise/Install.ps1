...
$appVendor = "Google"
$appName = "Chrome"
$appLongName = "Chrome Enterprise"
$appSetup = "GoogleChromeStandaloneEnterprise64.msi"
$appProcess = @("chrome","GoogleUpdate")
...
If ([version]$appVersion -gt [version]$appInstalledVersion) {
    ...
    Stop-ServiceAndDependencies -Name gupdate
    Set-ServiceStartMode -Name gupdate -StartMode "Disabled"
    Stop-ServiceAndDependencies -Name gupdatem
    Set-ServiceStartMode -Name gupdatem -StartMode "Disabled"
