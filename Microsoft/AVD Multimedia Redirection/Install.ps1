...
$appVendor = "Microsoft"
$appName = "AVD Multimedia Redirection"
$appName2 = "MsMmrHostMsi"
$appProcesses = @("MsMmrHost")
$appInstallParameters = "/QB"
$Evergreen = Get-EvergreenApp -Name MicrosoftWvdMultimediaRedirection
$appVersion = $Evergreen.Version
$appURL = $Evergreen.Uri
$appSetup = $Evergreen.Filename
$appDestination = "$env:ProgramFiles\MsRDCMMRHost"
[boolean]$IsAppInstalled = [boolean](Get-InstalledApplication -Name "$appName2")
$appInstalledVersion = ((Get-InstalledApplication -Name "$appName2").DisplayVersion)
