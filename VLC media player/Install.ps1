...
$appArchitecture = "x64"
$appConfigURL = "https://raw.githubusercontent.com/JonathanPitre/Apps/master/VLC%20media%20player/vlcrc"
...
If ([version]$appVersion -gt [version]$appInstalledVersion)
{
    ...
    Copy-File -Path "$appScriptPath\$appConfig" -Destination "$envSystemDrive\Users\Default\AppData\Roaming\vlc"
