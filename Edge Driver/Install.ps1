...
$appVendor = "Microsoft"
$appName = "Edge Driver"
$appProcesses = @("msedgedriver")
$appChannel = "Stable"
$appArchitecture = "x64"
$Evergreen = Get-EvergreenApp -Name MicrosoftEdgeDriver | Where-Object { $_.Channel -eq $appChannel -and $_.Architecture -eq $appArchitecture }
$appVersion = $Evergreen.Version
$appURL = $Evergreen.URI
$appZip = Split-Path -Path $appURL -Leaf
$appSetup = "msedgedriver.exe"
$appDestination = "${env:ProgramFiles(x86)}\$appVendor\EdgeDriver"
...
If ([version]$appVersion -gt [version]$appInstalledVersion)
{
    ...
    Copy-File -Path "$appScriptDirectory\$appVersion\$appSetup" "$appDestination\"
